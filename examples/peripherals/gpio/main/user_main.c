...
void app_main(void) {
    ...
    while (1) {
        ...
        gpio_set_level(GPIO_OUTPUT_IO_power, cnt%2);
        gpio_set_level(GPIO_OUTPUT_IO_speed, cnt%2);
        gpio_set_level(GPIO_OUTPUT_IO_rot, cnt%2);
        gpio_set_level(GPIO_OUTPUT_IO_windMode, cnt%2);
        gpio_set_level(GPIO_OUTPUT_IO_timer, cnt%2);
    }
}
